package com.example.kakaomapdatafetcher.service;

import com.example.kakaomapdatafetcher.config.NaverMapSeleniumProperties;
...
public class NaverMapSearchService {
    ...
    public JsonNode search(NaverMapSearchRequest request) {
        ...
        try {
            ...
            driver.get(properties.searchUrl() + UriUtils.encodePathSegment(request.q(), StandardCharsets.UTF_8));
    ...
    private String waitForSearchResponseBody(ChromeDriver driver) throws Exception {
        ...
        while (Instant.now().isBefore(deadline)) {
            ...
            for (LogEntry entry : logs) {
                ...
                Map<String, Object> bodyResult = driver.executeCdpCommand(
